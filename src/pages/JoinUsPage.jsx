  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Become a member of our IEEE Student Chapter and enjoy numerous benefits." />
      </Helmet>
      <div className="container mx-auto py-20 px-4 text-center">
        ...
        <div className="max-w-2xl mx-auto p-16 bg-card rounded-xl border border-dashed border-border">
          <p className="text-lg">Information about membership benefits and a registration form will be available here soon.</p>
        </div>
      </div>
    </>
  );
