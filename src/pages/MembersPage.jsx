...
const MembersPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Our Members | IEEE Student Chapter</title>
        <meta name="description" content="Meet the talented members of our IEEE Student Chapter, both past and present." />
      </Helmet>
      <div className="container mx-auto py-20 px-4 text-center">
        ...
        <div className="max-w-2xl mx-auto p-16 bg-card rounded-xl border border-dashed border-border">
          <p className="text-lg">A full directory of our members with search and filter capabilities will be available here soon.</p>
        </div>
      </div>
    </>
  );
